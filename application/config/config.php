...
|
*/
$config['base_url'] = 'http://127.0.0.1/Thongtanee/';
...
$config['smtp_host'] = 'thsv58.hostatom.com'; // Replace with your SMTP server address
$config['smtp_port'] = 587; // Replace with your SMTP server port
$config['smtp_user'] = 'assystem'; // Replace with your SMTP username
$config['smtp_pass'] = '1YdrR0!~8hHcQ7'; // Replace with your SMTP password
$config['smtp_crypto'] = 'tls'; // Use 'tls' or 'ssl' depending on your server
