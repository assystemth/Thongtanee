...
class Operation_rse_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_rse as $pdf) {
            $pdf->pdf = $this->operation_rse_model->list_all_pdf($pdf->operation_rse_id);
        }
        foreach ($operation_rse as $doc) {
            $doc->doc = $this->operation_rse_model->list_all_doc($doc->operation_rse_id);
        }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->operation_rse_model->del_pdf($pdf_id);
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->operation_rse_model->del_doc($doc_id);
    ...
    public function del_operation_rse($operation_rse_id)
    {
        ...
        $this->operation_rse_model->del_operation_rse_doc($operation_rse_id);
