...
class Pbsv_sags_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($pbsv_sags as $files) {
            $files->file = $this->pbsv_sags_model->list_all_pdf($files->pbsv_sags_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->pbsv_sags_model->del_pdf($file_id);
