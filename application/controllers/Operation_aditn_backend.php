...
class Operation_aditn_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_aditn as $files) {
            $files->file = $this->operation_aditn_model->list_all_pdf($files->operation_aditn_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->operation_aditn_model->del_pdf($file_id);
