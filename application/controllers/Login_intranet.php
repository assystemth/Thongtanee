...
class Login_intranet extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('login_form_intranet');
	...
	public function sendEmail()
	{
		...
		$this->db->set('reset_expiration', time() + 600);
		$this->db->where('m_username', $email);
	...
	public function resetPassword($reset_token)
	{
		...
		redirect('user'); // หรือส่งไปยังหน้าที่คุณต้องการให้ผู้ใช้เห็น
	}
