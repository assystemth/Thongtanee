...
class Operation_po_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_po as $files) {
            $files->file = $this->operation_po_model->list_all_pdf($files->operation_po_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->operation_po_model->del_pdf($file_id);
