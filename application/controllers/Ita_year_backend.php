...
class Ita_year_backend extends CI_Controller
{
    ...
    public function add_link()
    {
        ...
        $this->ita_year_model->add_link($ita_year_link_ref_id, $ita_year_link_name, $ita_year_link_link1, $ita_year_link_link2, $ita_year_link_link3, $ita_year_link_link4, $ita_year_link_link5);
    ...
    public function edit_link()
    {
        ...
        // echo '</pre>';
        // exit;
        $this->ita_year_model->edit_link($ita_year_link_id, $ita_year_link_ref_id, $ita_year_link_name, $ita_year_link_link1, $ita_year_link_link2, $ita_year_link_link3, $ita_year_link_link4, $ita_year_link_link5);
