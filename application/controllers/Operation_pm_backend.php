...
class Operation_pm_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_pm as $files) {
            $files->file = $this->operation_pm_model->list_all_pdf($files->operation_pm_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->operation_pm_model->del_pdf($file_id);
