...
class Operation_amf_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_amf as $pdf) {
            $pdf->pdf = $this->operation_amf_model->list_all_pdf($pdf->operation_amf_id);
        }
        foreach ($operation_amf as $doc) {
            $doc->doc = $this->operation_amf_model->list_all_doc($doc->operation_amf_id);
        }
    ...
    public function del_pdf($pdf_id)
    {
        ...
        $this->operation_amf_model->del_pdf($pdf_id);
    ...
    public function del_doc($doc_id)
    {
        ...
        $this->operation_amf_model->del_doc($doc_id);
    ...
    public function del_operation_amf($operation_amf_id)
    {
        ...
        $this->operation_amf_model->del_operation_amf_doc($operation_amf_id);
