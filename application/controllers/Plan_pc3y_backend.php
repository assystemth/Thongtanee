...
class Plan_pc3y_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($plan_pc3y as $files) {
            $files->file = $this->plan_pc3y_model->list_all_pdf($files->plan_pc3y_id);
        }
    ...
    public function editing($plan_pc3y_id)
    {
        ...
        $data['rsFile'] = $this->plan_pc3y_model->read_file($plan_pc3y_id);
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->plan_pc3y_model->del_pdf($file_id);
