...
class Operation_rdam_hr_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_rdam_hr as $files) {
            $files->file = $this->operation_rdam_hr_model->list_all_pdf($files->operation_rdam_hr_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->operation_rdam_hr_model->del_pdf($file_id);
