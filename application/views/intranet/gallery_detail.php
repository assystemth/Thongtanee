...
<div id="popupInsert" class="popup">
    <div class="popup-content">
        ...
        <form action="<?php echo site_url('Intra_gallery/add_img/' . $rsedit->intra_gallery_id); ?>" method="post"
...
<div class="flex-item-right-share-file">
    <div class="row">
        <div class="col-6 mt-5">
            ...
            <span class="font-folder-detail mx-3">
                <?= $rsedit->intra_gallery_name; ?>
            </span>
        </div>
        <div class="col-6 mt-5">
            <div class="d-flex justify-content-end">
                ...
                <a href="#" class="popup-insert" data-target="#popupInsert">
                    <img src="<?php echo base_url("docs/intranet/btn-intra-add-img-video.png"); ?>" width="auto"
                        style="max-width: 100%;">
                </a>
            </div>
        </div>
            ...
            for ($i = $startIndex; $i <= $endIndex; $i++) {
                ...
                <div class="col-sm-4" style="height: 31vh;">
                    <?php if (isset($currentItem->intra_gallery_img_id)): ?>
                        <!-- Display image -->
                        <img src="<?= base_url('docs/intranet/img/' . $currentItem->intra_gallery_img_img); ?>" width="90%"
                            height="80%">
                        <br>
                        <div class="row mt-3">
                            <div class="col-6">
                                ...
                                <?php if ($_SESSION['m_level'] == 1 || $_SESSION['m_level'] == 2 || $_SESSION['m_fname'] == $currentItem->intra_gallery_img_by): ?>
                                    <div class="d-flex justify-content-end mr-5">
                                        <a class="btn btn-danger btn-sm" href="#" role="button"
                                            onclick="confirmDeleteImg(<?= $currentItem->intra_gallery_img_id; ?>, '<?= $currentItem->intra_gallery_img_img; ?>');">
                    ...
                    <?php elseif (isset($currentItem->intra_gallery_video_id)): ?>
                        ...
                        <video width="90%" height="80%" controls>
                            <source src="<?= base_url('docs/intranet/video/' . $currentItem->intra_gallery_video_video); ?>"
                                type="video/mp4">
                        </video>
                        <br>
                        <div class="row mt-3">
                            ...
                            <div class="col-6">
                                <?php if ($_SESSION['m_level'] == 1 || $_SESSION['m_level'] == 2 || $_SESSION['m_fname'] == $currentItem->intra_gallery_video_by): ?>
                                    <div class="d-flex justify-content-end mr-5">
                                        <a class="btn btn-danger btn-sm" href="#" role="button"
                                            onclick="confirmDeleteVideo(<?= $currentItem->intra_gallery_video_id; ?>, '<?= $currentItem->intra_gallery_video_video; ?>');">
                                            <i class="bi bi-trash fa-lg mx-2"></i>ลบ
                                        </a>
                                    </div>
                                <?php endif; ?>
    ...
    <div class="row mt-3">
        <div class="col-sm-2">
            <a href="<?= site_url('Intra_gallery'); ?>" class="underline">
                <img src="<?php echo base_url("docs/intranet/btn-intra-back.png"); ?>" width="auto"
                    style="max-width: 100%;">
            </a>
        </div>
        <div class="col-sm-8">
