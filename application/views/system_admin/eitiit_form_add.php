<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลEIT IIT</h4>
            <form action=" <?php echo site_url('eitiit_backend/add_eitiit'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-2 control-label">ชื่อ</div>
                    <div class="col-sm-6">
                        <input type="text" name="eitiit_name" required class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="eitiit_link" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
