                       ...
                       <?php
                        ...
                        ?>
                           <tr role="row">
                               ...
                               <td class="limited-text"><?= $rs->p_palace_rank; ?></td>
                               <td class="limited-text"><?= $rs->p_palace_phone; ?></td>
                               <td><?= date('d/m/Y H:i', strtotime($rs->p_palace_datesave . '+543 years')) ?> น.</td>
                               <td>
                                   <a href="<?= site_url('p_palace_backend/editing_p_palace/' . $rs->p_palace_id); ?>"><i class="bi bi-pencil-square fa-lg "></i></a>
                                   <?php if (!($isDirector)) : ?>
                                       <a href="#" role="button" onclick="confirmDelete('<?= $rs->p_palace_id; ?>');"><i class="bi bi-trash fa-lg "></i></a>
                                   <?php endif; ?>
                                   <script>
                                       function confirmDelete(p_palace_id) {
                                           Swal.fire({
                                               title: 'กดเพื่อยืนยัน?',
                                               ...
                                               if (result.isConfirmed) {
                                                   window.location.href = "<?= site_url('p_palace_backend/del_p_palace/'); ?>" + p_palace_id;
                                               }
                                           });
                                       }
                                   </script>
