   <a class="btn add-btn" href="<?= site_url('p_employee_backend/adding_p_employee'); ?>" role="button">
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
           <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
           <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
       </svg> เพิ่มข้อมูล</a>
   <a class="btn btn-light" href="<?= site_url('p_employee_backend'); ?>" role="button">
                       ...
                       <?php
                        ...
                        ?>
                           <tr role="row">
                               ...
                               <td class="limited-text"><?= $rs->p_employee_rank; ?></td>
                               <td class="limited-text"><?= $rs->p_employee_phone; ?></td>
                               <td><?= date('d/m/Y H:i', strtotime($rs->p_employee_datesave . '+543 years')) ?> น.</td>
                               <td>
                                   <a href="<?= site_url('p_employee_backend/editing_p_employee/' . $rs->p_employee_id); ?>"><i class="bi bi-pencil-square fa-lg "></i></a>
                                   <?php if (!($isDirector)) : ?>
                                       <a href="#" role="button" onclick="confirmDelete('<?= $rs->p_employee_id; ?>');"><i class="bi bi-trash fa-lg "></i></a>
                                   <?php endif; ?>
                                   <script>
                                       function confirmDelete(p_employee_id) {
                                           Swal.fire({
                                               title: 'กดเพื่อยืนยัน?',
                                               ...
                                               if (result.isConfirmed) {
                                                   window.location.href = "<?= site_url('p_employee_backend/del_p_employee/'); ?>" + p_employee_id;
                                               }
                                           });
                                       }
                                   </script>
