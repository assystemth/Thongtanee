<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('odata_backend/edit_odata_sub_file/' . $rsedit->odata_sub_file_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
