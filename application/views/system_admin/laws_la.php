   <a class="btn add-btn" href="<?= site_url('laws_la_backend/adding'); ?>" role="button">
       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
           <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
           <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z" />
       </svg> เพิ่มข้อมูล</a>
   <a class="btn btn-light" href="<?= site_url('laws_la_backend'); ?>" role="button">
   ...
   <div class="card shadow mb-4">
       <div class="card-header py-3">
           <h6 class="m-0 font-weight-bold text-black">จัดการข้อมูลกฏหมายเพิ่มเติม</h6>
       </div>
       <div class="card-body">
                       ...
                       <?php
                        foreach ($query as $rs) { ?>
                           <tr role="row">
                               ...
                               <td><img src="<?= base_url('docs/img/' . $rs->laws_la_img); ?>" width="120px" height="80px"></td>
                               ...
                               <td>
                                   ...
                                   <script>
                                       function confirmDelete(laws_la_id) {
                                           Swal.fire({
                                               title: 'กดเพื่อยืนยัน?',
                                               ...
                                               if (result.isConfirmed) {
                                                   window.location.href = "<?= site_url('laws_la_backend/del_laws_la/'); ?>" + laws_la_id;
                                               }
                                           });
                                       }
                                   </script>
