<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>แก้ไขข้อมูลกฏหมายและระเบียบที่เกี่ยวข้อง</h4>
            <form action=" <?php echo site_url('laws_ral_backend/edit/' . $rsedit->laws_ral_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
