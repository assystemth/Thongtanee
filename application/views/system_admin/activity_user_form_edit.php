<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('activity_backend/edit_User_Activity/' . $rsedit->user_activity_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
