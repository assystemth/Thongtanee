<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูล LPA การประเมินประสิทธิภาพขององค์กร</h4>
            <form action=" <?php echo site_url('lpa_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-3 control-label">เรื่อง</div>
                    <div class="col-sm-9">
                        <input type="text" name="lpa_name" id="lpa_name" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="lpa_detail" id="lpa_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="lpa_date" id="lpa_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="lpa_link" id="lpa_link" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="lpa_pdf_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
