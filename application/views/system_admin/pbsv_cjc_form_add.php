<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลศูนย์ยุติธรรมชุมชน</h4>
            <form action=" <?php echo site_url('pbsv_cjc_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-3 control-label">เรื่อง</div>
                    <div class="col-sm-9">
                        <input type="text" name="pbsv_cjc_name" id="pbsv_cjc_name" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="pbsv_cjc_detail" id="pbsv_cjc_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="pbsv_cjc_date" id="pbsv_cjc_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="pbsv_cjc_link" id="pbsv_cjc_link" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="pbsv_cjc_file_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
