<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูล ITA การประเมินคุณธรรมของหน่วยงานภาครัฐ</h4>
            <form action=" <?php echo site_url('ita_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-3 control-label">เรื่อง</div>
                    <div class="col-sm-9">
                        <input type="text" name="ita_name" id="ita_name" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="ita_detail" id="ita_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="ita_date" id="ita_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="ita_link" id="ita_link" class="form-control">
                        <br>
                        <input type="text" name="ita_link2" id="ita_link2" class="form-control">
                        <br>
                        <input type="text" name="ita_link3" id="ita_link3" class="form-control">
                        <br>
                        <input type="text" name="ita_link4" id="ita_link4" class="form-control">
                        <br>
                        <input type="text" name="ita_link5" id="ita_link5" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="ita_pdf_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
