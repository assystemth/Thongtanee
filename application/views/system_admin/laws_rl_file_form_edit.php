<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>แก้ไขข้อมูลกฏหมายที่เกี่ยวข้องแบบไฟล์</h4>
            <form action=" <?php echo site_url('laws_rl_file_backend/edit/' . $rsedit->laws_rl_file_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
