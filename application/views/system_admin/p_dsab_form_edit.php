<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('p_dsab_backend/edit_p_dsab/' . $rsedit->p_dsab_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        เลือกใหม่
                        <br>
                        <input type="file" name="p_dsab_img" class="form-control" accept="image/*">
                    </div>
                </div>
                <br>
                <div class="col-sm-10">
                    <input type="hidden" name="p_dsab_id" value="<?= $rsedit->p_dsab_id; ?>">
                    <span class="fr"><?= form_error('p_dsab_id'); ?></span>
                    <div class="form-group row">
