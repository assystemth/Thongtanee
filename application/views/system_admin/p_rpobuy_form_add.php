<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลรายงานผลการดำเนินงานการจัดซื้อจัดจ้าง</h4>
            <form action=" <?php echo site_url('p_rpobuy_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-3 control-label">เรื่อง</div>
                    <div class="col-sm-9">
                        <input type="text" name="p_rpobuy_name" id="p_rpobuy_name" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="p_rpobuy_detail" id="p_rpobuy_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="datetime-local" name="p_rpobuy_date" id="p_rpobuy_date" class="form-control" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="p_rpobuy_link" id="p_rpobuy_link" class="form-control">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="p_rpobuy_file_pdf[]" class="form-control" accept="application/pdf" multiple>
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
