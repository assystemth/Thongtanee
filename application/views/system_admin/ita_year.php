   <a class="btn add-btn" href="<?= site_url('ita_year_backend/adding'); ?>" role="button">
                       ...
                       <?php
                        foreach ($query as $rs) { ?>
                           <tr role="row">
                               ...
                               <td>
                                   <a href="<?= site_url('ita_year_backend/editing/' . $rs->ita_year_id); ?>"><i class="bi bi-pencil-square fa-lg "></i></a>
                                   <a href="#" role="button" onclick="confirmDelete('<?= $rs->ita_year_id; ?>');"><i class="bi bi-trash fa-lg "></i></a>
                                   <script>
