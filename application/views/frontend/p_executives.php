<div class="bg-pages ">
    ...
    <div class="page-center">
        <div class="head-pages-two">
            <span class="font-pages-head">คณะผู้บริหาร</span>
        </div>
    </div>
    <div class="bg-pages-p">
        <div class="scrollable-container">  
                    ...
                    <?php if (!empty($rs->p_executives_rank)) : ?>
                        ...
                        <div class="mt-3 center-center">
                            ...
                            <span class="font-p-name">
                                <?php echo !empty($rs->p_executives_name) ? $rs->p_executives_name : 'ว่าง'; ?>
                            </span>
                            <!-- == -->
                            <span class="font-p-detail "><?= $rs->p_executives_rank; ?></span>
                            <?php if (!empty($rs->p_executives_phone)) : ?>
                                <span class="font-p-detail">เบอร์ <?= $rs->p_executives_phone; ?></span>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                <?php } ?>
            ...
            <!-- <?php foreach ($rsOne as $rs) { ?>
                    ...
                    <div class="mt-3 center-center">
                        <span class="font-p-name"><?= $rs->p_executives_name; ?></span>
                        <span class="font-p-detail "><?= $rs->p_executives_rank; ?></span>
                        <?php if (!empty($rs->p_executives_phone)) : ?>
                            <span class="font-p-detail">เบอร์ <?= $rs->p_executives_phone; ?></span>
                        <?php endif; ?>
