<div class="bg-pages ">
    ...
    <div class="bg-pages-in ">
        <div class="scrollable-container">
            <div class="font-pages-content-head">เรื่อง <?= $rsData->p_sopopip_name; ?></div>
            <div class="pages-content break-word mt-2">
                ...
                <?php foreach ($rsImg as $img) { ?>
                    <img class="border-radius34 mb-4 mt-4" src="<?php echo base_url('docs/img/' . $img->p_sopopip_img_img); ?>" width="950px" height="100%">
                <?php } ?>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="margin-top-delete-topic d-flex justify-content-end">
                    <a href="<?php echo site_url('Pages/p_sopopip'); ?>"><img src="<?php echo base_url("docs/k.btn-back.png"); ?>"></a>
                </div>
            </div>
        </div>
    </div>
