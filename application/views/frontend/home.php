    ...
    <div class="dropdown-container">
        ...
        <div class="dropdown-content">
            <ul class="no-bullets mt-4">
                ...
                <div class="dropdown-center">
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/ci'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ข้อมูลชุมชน</a></li>
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/si'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ยุทธศาสตร์การพัฒนาด้านโครงสร้างพื้นฐาน</a>
                    </li>
        ...
        <div class="dropdown-content">
            <ul class="no-bullets mt-4">
                ...
                <div class="dropdown-center">
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/plan_dpy'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;แผนการบริหารและพัฒนาทรัพยากรบุคคลประจำปี</a>
                    </li>
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/plan_pmda'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;แผนป้องกันและบรรเทาสาธารณะภัยประจำปี</a>
                    </li>
                </div>
                <div class="dropdown-right">
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/plan_spgl'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;มาตรฐานกำหนดตำแหน่งพนักงานเทศบาล</a></li>
                </div>
            </ul>
        </div>
        ...
        <div class="dropdown-content">
            <ul class="no-bullets mt-4">
                <div class="dropdown-left">
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/order'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;คำสั่งเทศบาล</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/announce'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ประกาศเทศบาล</a></li>
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/km'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;Knowledge Management :
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/mptae'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;มาตรการส่งเสริมคุณธรรมและความโปร่งใส</a>
                    </li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/operation_eg'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ประมวลจริยธรรมสำหรับเจ้าหน้าที่ของรัฐ</a>
                    </li>
                </div>
            </ul>
        </div>
        ...
        <div class="dropdown-content">
            <ul class="no-bullets mt-4">
                <div class="dropdown-left">
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/operation_policy_hr'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;นโยบายบริหารทรัพยากรบุคคล</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/operation_am_hr'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;การดำเนินการตามนโยบายการบริหาร<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ทรัพยากรบุคคล</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/operation_omp'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;การออกคำสั่งด้านการบริหารงานบุคคล</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/operation_cdm_topic'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;หลักเกณฑ์การบริหารและพัฒนา<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ทรัพยากรบุคคล</a></li>
                </div>
                <div class="dropdown-center">
                    <li><a class="mar-left-12 dropdown-item" href="<?php echo site_url('Pages/ita_all'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ITA การประเมินคุณธรรมและความโปร่งใส</a></li>
                    ...
                    <li><a class="mar-left-12 dropdown-item" href="<?php echo site_url('Pages/operation_pgn'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;นโยบายไม่รับของขวัญ no gift policy</a></li>
                    <li><a class="mar-left-12 dropdown-item" href="<?php echo site_url('Pages/operation_po'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;การเปิดโอกาสให้มีส่วนร่วม</a></li>
                    <li><a class="mar-left-12 dropdown-item" href="<?php echo site_url('Pages/operation_eco'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;การเสริมสร้างวัฒนธรรมองค์กร</a></li>
                    <li><a class="mar-left-12 dropdown-item" href="<?php echo site_url('Pages/lpa'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;LPA การประเมินประสิทธิภาพขององค์กร</a></li>
                </div>
                <div class="dropdown-right">
                    <li><a class="mar-left-3 dropdown-item"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;การจัดซื้อจัดจ้างหรือการจัดหาพัสดุ</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/p_rpobuy'); ?>"><img src="docs/k.item-img-navmid2.png">&nbsp;&nbsp;รายการจัดซื้อจัดจ้าง หรือการจัดหาพัสดุ</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/p_sopopip'); ?>"><img src="docs/k.item-img-navmid2.png">&nbsp;&nbsp;รายงานความก้าวหน้าการจัดซื้อจัดจ้าง<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หรือการจัดหาพัสดุ</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/p_sopopaortsr'); ?>"><img src="docs/k.item-img-navmid2.png">&nbsp;&nbsp;รายงานสรุปผลการจัดซื้อจัดจ้าง<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;หรือการจัดหาพัสดุประจำปี</a></li>
        ...
        <div class="dropdown-content">
            <ul class="no-bullets mt-4">
                <div class="dropdown-left">
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/pbsv_ae'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;ข้อมูลทะเบียนเบี้ยยังชีพผู้สูงอายุ</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/pbsv_rfc'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;รายงานการสำรวจความพึงพอใจการให้บริการ</a>
                    </li>
                </div>
                <div class="dropdown-center">
                    <!-- <li>
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/pbsv_oppr'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;งานอาสาสมัครป้องกันภัยฝ่ายพลเรือน
                            (อปพร.)</a></li>
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/pbsv_ems'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;งานกู้ชีพ / การบริการการแพทย์ฉุกเฉิน
                            (EMS)</a></li>
                ...
                <div class="dropdown-right">
                    ...
                    <li><a class="mar-left-9 dropdown-item" href="<?php echo site_url('Pages/adding_corruption'); ?>"><img src="docs/t.item-img-navmid.png">&nbsp;&nbsp;แจ้งเรื่องทุจริตหน่วยงานภาครัฐ</a></li>
...
<div class="bg-page-bottom">
    ...
    <div class="row" style="padding: 70px 60px">
        <div class="col-7">
            <div class="bg-qa-list underline">
            ...
            <div class="mt-5" style="z-index: 6;">
                <a href="https://www.nacc.go.th/NACCPPWFC?" target="_blank" rel="noopener noreferrer">
                    <img src="docs/t.raise_the_level_of_will3.jpg" width="702px" height="100px">
                </a>
            </div>
        </div>
        ...
        <div class="col-5 ">
            ...
            <div class="d-flex justify-content-end mt-5">
                <a href="https://itas.nacc.go.th/go/iit/1e8vml" target="_blank" rel="noopener noreferrer">
                    <img src="docs/iit.jpg" width="386px" height="546px">
                </a>
            </div>
        </div>
    </div>
