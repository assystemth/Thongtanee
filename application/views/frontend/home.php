            ...
            <div class="card-activity col-2 ">
                <?php if (!empty($activity->activity_img)): ?>
                    <a href="<?= site_url('pages/activity_detail/' . $activity->activity_id); ?>">
                        <img src="<?php echo base_url('docs/img/' . $activity->activity_img); ?>" width="180px" height="160px"
...
<div class="bg-page-bottom">
    ...
    <div class="row" style="padding: 70px 60px">
        ...
        <div class="col-5 ">
            ...
            <div class="d-flex justify-content-end">
                <div id="carouselExampleAutoplayingITA" class="carousel slide" data-bs-ride="carousel"
                    style="z-index: 10;  margin-top: -15px;">
                    <div class="carousel-indicators">
                        <?php
                        ...
                        <?php foreach ($qPublicize_ita as $index => $img_publicize_ita) { ?>
                            <div class="carousel-item <?= ($index === 0) ? "active" : ""; ?>" data-bs-interval="3000">
                                <a href="<?= $img_publicize_ita->publicize_ita_link; ?>" target="_blank">
                                    <img src="docs\img\<?= $img_publicize_ita->publicize_ita_img; ?>" class="d-block "
                                        style="height: 546px; width: 386px;">
                                </a>
                            </div>
                        <?php } ?>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleAutoplayingITA"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleAutoplayingITA"
                        data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Next</span>
                    </button>
