<div class="bg-pages">
           ...
           <div class="path2-3">
                <span class="font-path-2 underline"><a href="#">ITA เทศบาลธงธานี</a></span>
            </div>
        </div>
            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/ita_detail/' . $rs->ita_id); ?>">
                            <?php if (!empty($rs->ita_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->ita_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/ita_detail/' . $rs->ita_id); ?>">
                            <span class="one-line-ellipsis"><?= $rs->ita_name; ?></span>
                        </a>
                    </div>
