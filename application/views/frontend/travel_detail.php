<div class="bg-pages ">
    ...
    <div class="bg-pages-in">
        <div>
            <img class="border-radius-travel" src="<?php echo base_url('docs/img/' . $rsTravel->travel_img); ?>"
            ...
            <?php if (!empty($rsTravel->travel_youtube)): ?>
                <div class="d-flex justify-content-end" style="margin-top: -95px; padding-right: 30px; ">
                    <a href="<?= $rsTravel->travel_youtube; ?>" target="_blank">
                        <svg style="color: red;" xmlns="http://www.w3.org/2000/svg" width="100" height="100"
        ...
        <div class="scrollable-container-550">
            <div class="page-content-travel">
                ...
                <span class="font-page-detail-time-img"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="14"
                ...
                <span class="font-page-detail-time-img">
                    <svg xmlns="http://www.w3.org/2000/svg" width="13" height="14" fill="currentColor"
                ...
                <br>
                <span class="font-page-detail-content-img">ตำแหน่งที่ตั้ง</span> : <span
                    class="font-page-detail-content-img underline"><?= $rsTravel->travel_location; ?> <a
                        class="btn btn-success" target="_blank" href="<?= $rsTravel->travel_map; ?>">Google
                        Map</a></span>
                <br>
                <span class="font-page-detail-content-img">เวลาทำการ</span> : <span
                    class="font-page-detail-content-img"><?= $rsTravel->travel_date; ?>&nbsp;<?= $rsTravel->travel_timeopen; ?>
                    - <?= $rsTravel->travel_timeclose; ?> น.</span>
                <br>
                <span class="font-page-detail-content-img">โทรศัพท์</span> : <span
                    class="font-page-detail-content-img"><?= $rsTravel->travel_phone; ?></span>
                <br>
                <span class="font-page-detail-content-img">แหล่งที่มา</span> : <span
                    class="font-page-detail-content-img"><a href="<?= $rsTravel->travel_refer; ?>"
                        target="_blank"><?= $rsTravel->travel_refer; ?></a></span>
                <!-- <div class="popup"> -->
                <div class="row mt-5">
                    <?php foreach ($rsImg as $img) { ?>
                        <div class="col-3 mb-3">
                            <a href="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>" data-lightbox="image-1">
                                <img class="rounded-all" src="<?php echo base_url('docs/img/' . $img->travel_img_img); ?>"
                                    width="209px" height="202px">
                            </a>
                        </div>
                    <?php } ?>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="margin-top-delete-travel d-flex justify-content-end">
                    <a href="<?php echo site_url('Pages/travel'); ?>"><img
