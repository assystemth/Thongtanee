                    ...
                    <?php if (!empty($rs->p_palace_name)) : ?>
                        <div class="bg-personnel-s">
                            <div class="rounded-image-s">
                                <img src="<?= base_url('docs/img/' . $rs->p_palace_img); ?>" width="100%" height="100%">
                            </div>
                        </div>
                        <div class="mt-3 center-center">
                            <span class="font-p-name"><?= $rs->p_palace_name; ?></span>
                            <span class="font-p-detail "><?= $rs->p_palace_rank; ?></span>
                            <?php if (!empty($rs->p_palace_phone)) : ?>
                                <span class="font-p-detail">เบอร์ <?= $rs->p_palace_phone; ?></span>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                <?php } ?>
