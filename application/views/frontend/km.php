            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/km_detail/' . $rs->km_id); ?>">
                            <?php if (!empty($rs->km_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->km_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/km_detail/' . $rs->km_id); ?>">
                            <span class="one-line-ellipsis"><?= $rs->km_name; ?></span>
                        </a>
                    </div>
