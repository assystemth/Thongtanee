<div class="bg-pages">
    <div class="row pad-path">
        ...
        <div class="path2-3">
            <span class="font-path-2 underline"><a href="#">รายงานงบประมาณ</a></span>
        </div>
    </div>
            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/p_reb_detail/' . $rs->p_reb_id); ?>">
                            <?php if (!empty($rs->p_reb_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->p_reb_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/p_reb_detail/' . $rs->p_reb_id); ?>">
                            <span class="one-line-ellipsis mt-1"><?= $rs->p_reb_name; ?></span>
                        </a>
                    </div>
                    <div class="col-2 span-time-pages-news">
                        <a href="<?php echo site_url('Pages/p_reb_detail/' . $rs->p_reb_id); ?>">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" fill="currentColor" class="bi bi-calendar-minus-fill" viewBox="0 0 16 16">
                                ...
                                $date = new DateTime($rs->p_reb_date);
