    ...
    <div class="container-pages-news">
        ...
        <div class="bg-pages-in-e-service ">
            <div class="pages-form-es-complain underline">
                <form action=" <?php echo site_url('Pages/add_complain'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                    <br>
                    <br>
                    <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 mt-2">
                                    <input type="email" name="complain_email" class="form-control font-label-e-service-complain" required placeholder="example@youremail.com">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 mt-2">
                            <input type="file" name="complain_imgs[]" class="form-control " accept="image/*" multiple required>
                        </div>
                    </div>
            </div>
            <div class="row">
