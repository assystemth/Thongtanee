<div class="bg-pages ">
    ...
    <div class="page-center">
        <div class="head-pages-two">
            <span class="font-pages-head-long">ศูนย์พัฒนาเด็กเล็กบ้านบักจรัง</span>
        </div>
    </div>
    <div class="bg-pages">
                ...
                <?php foreach ($rsOne as $rs) { ?>
                    <div class="bg-personnel-s">
                        <div class="rounded-image-s">
                            <img src="<?= base_url('docs/img/' . $rs->p_cdc_bbj_img); ?>" width="100%" height="100%">
                        </div>
                    </div>
                    <div class="mt-4 center-center">
                        <span class="font-p-name"><?= $rs->p_cdc_bbj_name; ?></span>
                        <span class="font-p-rank"><?= $rs->p_cdc_bbj_rank; ?></span>
                        <?php if (!empty($rs->p_cdc_bbj_phone)) : ?>
                            <span class="font-p-detail">เบอร์ <?= $rs->p_cdc_bbj_phone; ?></span>
                        <?php endif; ?>
                    </div>
                <?php } ?>
            </div>
