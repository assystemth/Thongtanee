        ...
        <div class="scrollable-container">
                ...
                <?php foreach ($rsImg as $img) { ?>
                    <div class="col-3 mb-3">
                        <img class="rounded-all" src="<?php echo base_url('docs/img/' . $img->canon_chh_img_img); ?>" width="950px" height="100%">
                    </div>
                <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-6 mt-2">
                            <div class="d-flex justify-content-start">
                                <span class="font-page-detail-view-news">ดาวน์โหลดแล้ว <?= $file->canon_chh_file_download; ?> ครั้ง</span>
                            </div>
                        </div>
                        <div class="col-6">
