<div class="bg-pages">
    <div class="row pad-path">
        ...
        <div class="path2-1">
            <span class="font-path-2 underline"><a href="#">ผังเว็บไซต์</a></span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35 mt-1 mb-1">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/travel'); ?>" class="font-content-all-web">แหล่งท่องเที่ยว</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <a href="<?php echo site_url('Pages/operation_reauf'); ?>" class="font-content-all-web">รายงานการติดตามประเมินผลแผนพัฒนาท้องถิ่น</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_rse'); ?>" class="font-content-all-web">รายงานผลการประหยัดพลังงาน</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_rdam_hr'); ?>" class="font-content-all-web">การบริหารและพัฒนาทรัพยากรบุคคล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_policy_hr'); ?>" class="font-content-all-web">นโยบายบริหารทรัพยากรบุคคล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_am_hr'); ?>" class="font-content-all-web">การดำเนินการบริหารทรัพยากรบุคคล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_omp'); ?>" class="font-content-all-web">การดำเนินการบริหารทรัพยากรบุคคล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_cdm_topic'); ?>" class="font-content-all-web">หลักเกณฑ์การบริหารและพัฒนา</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_mcc'); ?>" class="font-content-all-web">การจัดการเรื่องร้องเรียนการทุจริต</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_sp'); ?>" class="font-content-all-web">สรปุผลการจัดซื้อจัดจ้าง</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_erc'); ?>" class="font-content-all-web">การประเมินความเสี่ยงการทุจริตประพฤติมิชอบ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/operation_amf'); ?>" class="font-content-all-web">การดำเนินการเพื่อจัดการความเสี่ยงการทุจริต</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35 mt-2 mb-2">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_ae'); ?>" class="font-content-all-web">ข้อมูลทะเบียนเบี้ยยังชีพผู้สูงอายุ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_rfc'); ?>" class="font-content-all-web">รายงานการสำรวจความพึงพอใจการให้บริการ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_is'); ?>" class="font-content-all-web">ข้อมูลบริการ</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_ahs'); ?>" class="font-content-all-web">หลักประกันสุขภาพเทศบาล</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_fp'); ?>" class="font-content-all-web">การรับฟังความคิดเห็นของประชาชน</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/pbsv_ppdp'); ?>" class="font-content-all-web">นโยบายคุ้มครองข้อมูลส่วนบุคคล</a><br>
                        </div>
                    </div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/adding_suggestions'); ?>" class="font-content-all-web">รับฟังความคิดเห็น</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/contact'); ?>" class="font-content-all-web">ติดต่อสอบถาม</a><br>
                        </div>
                    </div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            <a href="<?php echo site_url('Pages/order'); ?>" class="font-content-all-web">คำสั่งเทศบาล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/announce'); ?>" class="font-content-all-web">ประกาศเทศบาล</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/km'); ?>" class="font-content-all-web">การจัดการความรู้ท้องถิ่น KM</a><br>
                            <div class="mt-1"></div>
                ...
                <div class="content-all-web">
                        ...
                        <div class="underline pad-left-35 mt-1 mb-1">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_palace'); ?>" class="font-content-all-web">ทำเนียบเทศบาลธงธานี</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_employee'); ?>" class="font-content-all-web">พนักงานเทศบาล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_deputy'); ?>" class="font-content-all-web">สำนักปลัดองค์การบริหารส่วนเทศบาล</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_treasury'); ?>" class="font-content-all-web">กองคลัง</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_maintenance'); ?>" class="font-content-all-web">กองช่าง</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/P_audit'); ?>" class="font-content-all-web">กองประปา</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/P_dsab'); ?>" class="font-content-all-web">กองสาธารณสุขและสิ่งแวดล้อม</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/p_education'); ?>" class="font-content-all-web">กองการศึกษาศาสนาและวัฒนธรรม</a><br>
                        </div>
                    </div>

                    <div class="content-all-web mt-4">
                        <span class="font-head-all-web">ข้อบัญญัติ</span><br>
                        <div class="underline mt-1 mb-1 pad-left-35">
                            <a href="<?php echo site_url('Pages/canon_bgps'); ?>" class="font-content-all-web">ข้อบัญญัติงบประมาณ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_chh'); ?>" class="font-content-all-web">ข้อบัญญัติการควบคุมกิจการที่เป็นอันตรายต่อสุขภาพ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_ritw'); ?>" class="font-content-all-web">ข้อบัญญัติการติดตั้งระบบบำบัดน้ำเสียในอาคาร</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_market'); ?>" class="font-content-all-web">ข้อบัญญัติตลาด</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_rmwp'); ?>" class="font-content-all-web">ข้อบัญญัติการจัดการสิ่งปฏิกูลและมูลฝอย</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_rcsp'); ?>" class="font-content-all-web">ข้อบัญญัติหลักเกณฑ์การคัดแยกมูลฝอย</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/canon_rcp'); ?>" class="font-content-all-web">ข้อบัญญัติการควบคุมการเลี้ยงหรือปล่อยสุนัขและแมว</a><br>
                            <div class="mt-1"></div>
                    ...
                    <div class="content-all-web mt-4">
                        ...
                        <div class="underline pad-left-35">
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_bgy'); ?>" class="font-content-all-web">แผนการใช้จ่ายงบประมาณประจำปี</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_pse'); ?>" class="font-content-all-web">แผนการประหยัดพลังงาน</a><br>
                            <div class="mt-1"></div>
                            ...
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_pae'); ?>" class="font-content-all-web">โครงการส่งเสริมกิจกรรมผู้สูงอายุ</a><br>
                            <div class="mt-1"></div>
                            <a href="<?php echo site_url('Pages/plan_spgl'); ?>" class="font-content-all-web">มาตรฐานกำหมดตำแหน่งพนักงานเทศบาล</a><br>
                        </div>
                    </div>
                </div>
            </div>
