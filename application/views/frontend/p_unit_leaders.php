<div class="bg-pages ">
    ...
    <div class="page-center">
        <div class="head-pages">
            <span class="font-pages-head-long">หัวหน้าส่วนราชาการ</span>
        </div>
    </div>
                ...
                <div class="page-center">
                    <?php foreach ($query_one as $rs) { ?>
                        ...
                        <div class="mt-3 center-center">
                            <span class="font-p-name"><?= $rs->p_unit_leaders_name; ?></span>
                            <span class="font-p-detail "><?= $rs->p_unit_leaders_rank; ?></span>
                            <?php if (!empty($rs->p_unit_leaders_phone)) : ?>
                                <span class="font-p-detail">เบอร์ <?= $rs->p_unit_leaders_phone; ?></span>
                            <?php endif; ?>
                        </div>
                    <?php } ?>
                </div>
