    ...
    <div class="bg">
        ...
        <form id="reCAPTCHA3" action="<?php echo site_url('Login_intranet/check2'); ?>" method="post">
            ...
            <div style="margin-left: 10%;" >
                ...
                <button data-action='submit' data-callback='onSubmit' data-sitekey="6LcfiLYpAAAAAI7_U3nkRRxKF7e8B_fwOGqi7g6x" ype="submit" class="loginBtn g-recaptcha" id="loginBtn">เข้าสู่ระบบ</button>
            </div>
