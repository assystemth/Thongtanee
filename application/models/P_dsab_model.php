...
class P_dsab_model extends CI_Model
{
    ...
    public function p_dsab_frontend_one()
    {
        ...
        $this->db->where_in('tbl_p_dsab.p_dsab_id', 1);
        $query = $this->db->get();
        return $query->result();
    }
    ...
    //     $this->db->select('*');
    //     $this->db->from('tbl_p_dsab');
    //     $this->db->where('tbl_p_dsab.p_dsab_rank', 'ผู้อำนวยการกองการศึกษาฯ');
    //     $this->db->order_by('tbl_p_dsab.p_dsab_id', 'DESC');
    //     $query = $this->db->get();
    //     return $query->result();
    // }
    ...
    //     $this->db->select('*');
    //     $this->db->from('tbl_p_dsab');
    //     $this->db->where_not_in('p_dsab_rank', $positions_to_exclude);
