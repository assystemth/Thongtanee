...
class Operation_eco_model extends CI_Model
{
    ...
    public function list_all()
    {
        ...
        $this->db->group_by('tbl_operation_eco.operation_eco_id');
    ...
    {
        // ดึงชื่อไฟล์ PDF จากฐานข้อมูลโดยใช้ $file_id
        $this->db->select('operation_eco_img_img');
    ...
    public function del_operation_eco_pdf($operation_eco_id)
    {
        ...
        foreach ($files as $files) {
            $file_path = './docs/file/' . $files->operation_eco_file_pdf;
            if (file_exists($file_path)) {
                unlink($file_path);
            }
        }
    ...
    public function update_operation_eco_status()
    {
        ...
        if ($this->input->post()) {
            $operation_ecoId = $this->input->post('operation_eco_id'); // รับค่า operation_eco_id
            ...
            $this->db->where('operation_eco_id', $operation_ecoId); // ระบุ operation_eco_id ของแถวที่ต้องการอัพเดต
            $this->db->update('tbl_operation_eco', $data);
    ...
    public function operation_eco_frontend()
    {
        $this->db->select('*');
        $this->db->from('tbl_operation_eco');
