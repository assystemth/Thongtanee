        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('p_maintenance_backend/edit_p_maintenance/' . $rsedit->p_maintenance_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="p_maintenance_name" required class="form-control" value="<?= $rsedit->p_maintenance_name; ?>">
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?php
                        $position = $rsedit->p_maintenance_rank;
                        $isDisabled = ($position == 'ผู้อำนวยการกองช่าง') ? 'readonly' : '';
                        ?>
                        <input type="text" name="p_maintenance_rank" class="form-control" value="<?= $position; ?>" <?= $isDisabled; ?>>
                        <span class="fr"><?= form_error('p_maintenance_rank'); ?></span>
                    </div>
                </div>
                <br> -->
                ...
                <br>
                <?php if ($rsedit->p_maintenance_id != 1) : ?>
                    <div class="form-group row">
                        <div class="col-sm-2 control-label">ตำแหน่งในการแสดงผล</div>
                        <div class="col-sm-4">
                            <select class="form-control" id="p_maintenance_column" name="p_maintenance_column">
                                <option value="<?php echo $rsedit->p_maintenance_column; ?>"><?php echo $rsedit->p_maintenance_column; ?></option>
