        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('activity_backend/add_Activity'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="activity_name" id="activity_name"></textarea>
                        <script>
                            ClassicEditor
                ...
                <!-- <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" name="activity_timeopen" required class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="datetime-local" name="activity_timeclose" required class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="activity_img" class="form-control" accept="image/*" required>
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="activity_imgs[]" class="form-control" accept="image/*" multiple>
