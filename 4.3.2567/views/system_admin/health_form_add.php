<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลสาธารณสุข</h4>
            <form action=" <?php echo site_url('health_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
                <div class="form-group row">
                    <div class="col-sm-3 control-label">ย่อหน้าสาธรณสุข</div>
                    <div class="col-sm-9">
                        <textarea name="health_name" id="health_name"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea name="health_detail" id="health_detail"></textarea>
                        <script>
                            ClassicEditor
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="health_imgs[]" class="form-control" accept="image/*" multiple>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="file" name="health_file" class="form-control" accept=".pdf">
                        <span class="black-add">สามารถอัพโหลดได้หลายไฟล์</span>
                        <br>
