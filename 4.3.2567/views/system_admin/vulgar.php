   ...
   <div class="card shadow mb-4">
       <div class="card-header py-3">
           <h6 class="m-0 font-weight-bold text-black">จัดการข้อมูลกรองคำหยาย</h6>
       </div>
       <div class="card-body">
                       ...
                       <?php
                        foreach ($query as $rs) { ?>
                           <tr role="row">
                               ...
                               <td><?php echo $rs->vulgar_com; ?></td>
                               <td><?php echo $rs->vulgar_by; ?></td>
                               <td><?= date('d/m/Y H:i', strtotime($rs->vulgar_datesave . '+543 years')) ?> น.</td>
                               <td>
                                   <a href="<?= site_url('vulgar_backend/editing/' . $rs->vulgar_id); ?>"><i class="bi bi-pencil-square fa-lg "></i></a>
                                   <a href="#" role="button" onclick="confirmDelete(<?= $rs->vulgar_id; ?>);"><i class="bi bi-trash fa-lg "></i></a>
                                   <script>
