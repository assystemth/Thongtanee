<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('Ci_backend/edit/' . $rsedit->ci_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
            <br>
                ...
                <br>
                <div class="form-group row">
                    <div class="col-sm-2 control-label">จำนวนบ้าน</div>
                    <div class="col-sm-5">
