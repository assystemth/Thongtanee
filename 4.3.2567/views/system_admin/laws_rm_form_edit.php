<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>แก้ไขข้อมูลกฏกระทรวง</h4>
            <form action=" <?php echo site_url('laws_rm_backend/edit/' . $rsedit->laws_rm_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
