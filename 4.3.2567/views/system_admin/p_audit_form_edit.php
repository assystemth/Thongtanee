        ...
        <div class="col-md-7">
            ...
            <form action=" <?php echo site_url('p_audit_backend/edit_p_audit/' . $rsedit->p_audit_id); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="p_audit_name" required class="form-control" value="<?= $rsedit->p_audit_name; ?>">
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <?php
                        $position = $rsedit->p_audit_rank;
                        $isDisabled = ($position == 'ปลัดองค์การบริหารส่วนตำบล') ? 'readonly' : '';
                        ?>
                        <input type="text" name="p_audit_rank" class="form-control" value="<?= $position; ?>" <?= $isDisabled; ?>>
                        <span class="fr"><?= form_error('p_audit_rank'); ?></span>
                    </div>
                </div>
                <br> -->
                <?php if ($rsedit->p_audit_id != 1) : ?>
                    <div class="form-group row">
                        <div class="col-sm-2 control-label">ตำแหน่งในการแสดงผล</div>
                        <div class="col-sm-4">
                            <select class="form-control" id="p_audit_column" name="p_audit_column">
                                <option value="<?php echo $rsedit->p_audit_column; ?>"><?php echo $rsedit->p_audit_column; ?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" pattern="\d{9,10}" title="กรุณากรอกเบอร์มือถือเป็นตัวเลข 9 หรือ 10 ตัว" name="p_audit_phone" class="form-control" value="<?= $rsedit->p_audit_phone; ?>">
