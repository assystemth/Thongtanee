<div class="container">
    <div class="row">
        ...
        <div class="col-md-7">
            <h4>เพิ่มข้อมูลกฏหมายที่เกี่ยวข้องแบบโฟลเดอร์</h4>
            <form action=" <?php echo site_url('laws_rl_folder_backend/add'); ?> " method="post" class="form-horizontal" enctype="multipart/form-data">
                <br>
