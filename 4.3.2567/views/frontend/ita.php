<div class="bg-pages-news">
    <div class="container-pages-news">
        ...
        <div class="row">
            ...
            <div class="path2-2">
                <span class="font-path-2 underline"><a href="#">ITA อบต. สว่าง</a></span>
            </div>
        </div>
        <div style="padding-top: 40px;"></div>
        <?php
        $countQIta = count($qIta);
        $countQItaYear = count($qItaYear);

        $totalItems = $countQIta + $countQItaYear;
        ...
        for ($i = $startIndex; $i <= $endIndex; $i++) {
            if ($i < $countQIta) {
                $currentRs = $qIta[$i];
                // นำโค้ดที่ต้องการแสดงจาก $qIta มาต่อท้าย
        ?>
                <div class="pages-select-pdf underline">
                    <div class="row">
                        <div class="col-1 style-col-img">
                            <a href="<?php echo site_url('Pages/ita_detail/' . $currentRs->ita_id); ?>">
                                <?php if (!empty($currentRs->ita_img)) : ?>
                                    <img class="border-radius24" src="<?php echo base_url('docs/img/' . $currentRs->ita_img); ?>" width="94px" height="63px">
                                <?php else : ?>
                        ...
                        <div class="col-9 font-pages-content">
                            <a href="<?php echo site_url('Pages/ita_detail/' . $currentRs->ita_id); ?>">
                                <span class="one-line-ellipsis"><?= $currentRs->ita_name; ?></span>
                            </a>
                        </div>
                        <div class="col-2 span-time-pages-news">
                            <a href="<?php echo site_url('Pages/ita_detail/' . $currentRs->ita_id); ?>">
                                <span><svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" fill="currentColor" class="bi bi-calendar-minus-fill" viewBox="0 0 16 16">
                                    ...
                                    $date = new DateTime($currentRs->ita_date);
            ...
            <?php
                ...
                $currentRs = $qItaYear[$i - $countQIta];
                // นำโค้ดที่ต้องการแสดงจาก $qItaYear มาต่อท้าย
            ?>
                <div class="pages-select-pdf underline">
                    <div class="row">
                        <div class="col-1 style-col-img">
                            <a href="<?php echo site_url('Pages/ita_year/' . $currentRs->ita_year_id); ?>">
                                <img class="border-radius24" src="<?php echo base_url('docs/logo.png'); ?>" width="94px" height="63px">
                            </a>
                        </div>
                        <div class="col-9 font-pages-content">
                            <a href="<?php echo site_url('Pages/ita_year/' . $currentRs->ita_year_id); ?>">
                                <span class="one-line-ellipsis"><?= $currentRs->ita_year_year; ?></span>
                            </a>
                        </div>
                        <div class="col-2 span-time-pages-news">
                            <a href="<?php echo site_url('Pages/ita_year/' . $currentRs->ita_year_id); ?>">
