    ...
    <div class="container-pages-detail">
        <div class="page-center">
            <div class="head-pages">
                <span class="font-pages-head">ดาวน์โหลดแบบฟอร์ม
                    <br>E-book</span>
            </div>
        </div>
        <div class="row">
        ...
        <div class="bg-pages-in ">
            <div class="scrollable-container-news">
                <div class="font-pages-content-head">เรื่อง <?= $rsData->pbsv_e_book_name; ?></div>
                <div class="pages-content break-word mt-2">
                    ...
                    <?php foreach ($rsImg as $img) { ?>
                            <img class="border-radius34 mb-4" src="<?php echo base_url('docs/img/' . $img->pbsv_e_book_img_img); ?>" width="950px" height="100%">
                    <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="margin-top-delete-topic d-flex justify-content-end">
                        <a href="<?php echo site_url('Pages/pbsv_e_book'); ?>"><img src="<?php echo base_url("docs/s.btn-back.png"); ?>"></a>
                    </div>
                </div>
            </div>
        </div>
