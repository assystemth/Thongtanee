            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/mui_detail/' . $rs->mui_id); ?>">
                            <?php if (!empty($rs->mui_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->mui_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/mui_detail/' . $rs->mui_id); ?>">
                            <span class="one-line-ellipsis mt-1"><?= $rs->mui_name; ?></span>
                        </a>
                    </div>
