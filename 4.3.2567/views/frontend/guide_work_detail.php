<div class="bg-pages ">
    <div class="container-pages-detail">
        ...
        <div class="row">
            ...
            <div class="path2-4">
                <span class="font-path-2 underline"><a href="#">คู่มือการปฏิบัติงาน</a></span>
            </div>
        </div>
        <div class="bg-pages-in ">
            <div class="scrollable-container-news">
                <div class="font-pages-content-head">เรื่อง <?= $rsData->guide_work_name; ?></div>
                ...
                <?php foreach ($rsImg as $img) { ?>
                    <div class="col-3 mb-3">
                        <img class="rounded-all" src="<?php echo base_url('docs/img/' . $img->guide_work_img_img); ?>" width="950px" height="100%">
                    </div>
                <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="margin-top-delete-topic d-flex justify-content-end">
                        <a href="<?php echo site_url('Pages/guide_work'); ?>"><img src="<?php echo base_url("docs/s.btn-back.png"); ?>"></a>
                    </div>
                </div>
            </div>
        </div>
