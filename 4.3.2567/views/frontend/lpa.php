    ...
    <div class="container-pages-news">
        <div class="page-center">
            <div class="head-pages-three">
                <span class="font-pages-head">LPA การประเมินประสิทธิภาพขององค์กร</span>
            </div>
        </div>
        <div class="row">
            <div class="path1-1">
            ...
            <div class="pages-select-pdf underline">
                <div class="row">
                    <div class="col-1 style-col-img">
                        <a href="<?php echo site_url('Pages/lpa_detail/' . $rs->lpa_id); ?>">
                            <?php if (!empty($rs->lpa_img)) : ?>
                                <img class="border-radius24" src="<?php echo base_url('docs/img/' . $rs->lpa_img); ?>" width="94px" height="63px">
                            <?php else : ?>
                    ...
                    <div class="col-9 font-pages-content">
                        <a href="<?php echo site_url('Pages/lpa_detail/' . $rs->lpa_id); ?>">
                            <span class="one-line-ellipsis"><?= $rs->lpa_name; ?></span>
                        </a>
                    </div>
