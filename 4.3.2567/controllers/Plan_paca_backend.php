...
class Plan_paca_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($plan_paca as $files) {
            $files->file = $this->plan_paca_model->list_all_pdf($files->plan_paca_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->plan_paca_model->del_pdf($file_id);
