...
class Operation_policy_hr_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($operation_policy_hr as $files) {
            $files->file = $this->operation_policy_hr_model->list_all_pdf($files->operation_policy_hr_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->operation_policy_hr_model->del_pdf($file_id);
