...
class Pbsv_cac_backend extends CI_Controller
{
    ...
    public function index()
    {
        ...
        foreach ($pbsv_cac as $files) {
            $files->file = $this->pbsv_cac_model->list_all_pdf($files->pbsv_cac_id);
        }
    ...
    public function del_pdf($file_id)
    {
        ...
        $this->pbsv_cac_model->del_pdf($file_id);
